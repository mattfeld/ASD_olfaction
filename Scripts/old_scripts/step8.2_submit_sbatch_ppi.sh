...
# written by Nathan Muncy on 7/02/18


### Notes:
# This is a wrapper script used to submit the step8.2_sbatch job
...
for i in ${subjList[@]}; do
    ...
    sbatch \
    -o ${outDir}/output_ppi8.2_${i}.txt \
    -e ${outDir}/error_ppi8.2_${i}.txt \
    ${scriptDir}/step8.2_sbatch_ppi.sh $i
