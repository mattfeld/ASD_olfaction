...
### Notes:
# This is a wrapper script used to submit the step8_sbatch job
...
for i in ${subjList[@]}; do
    ...
    sbatch \
    -o ${outDir}/output_ppi8_${i}.txt \
    -e ${outDir}/error_ppi8_${i}.txt \
    ${scriptDir}/step8_sbatch_ppi.sh $i
